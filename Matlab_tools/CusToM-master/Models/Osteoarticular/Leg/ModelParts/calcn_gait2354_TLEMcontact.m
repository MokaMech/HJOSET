function [Human_model]= calcn_gait2354_TLEMcontact(Human_model,k,Signe,Mass,AttachmentPoint)
%	CREDIT
...
calcn_position_set = {...
    ...
    [Signe '_TLEM_Heel_Contact'], k*Mirror *[-0.026100;-0.025;-0.0021000]- CoM_calcn;...
    [Signe '_TLEM_5th_MetatarsalContact'], k*Mirror *[0.1788+0.097900-0.11390;-0.015;0.00108+0.033000+0.0021000]- CoM_calcn;...
    [Signe '_TLEM_2nd_MetatarsalContact'], k*Mirror *[0.1788+0.11390-0.11390;-0.015;0.00108-0.0021000+0.0021000]- CoM_calcn;...
    [Signe '_TLEM_1st_MetatarsalContact'], k*Mirror *[0.1788+0.12190-0.11390;-0.015;0.00108-0.019600+0.0021000]- CoM_calcn;...
    [Signe '_TLEM_BigToeContact'], k*Mirror *[0.26;0.03;0]- CoM_calcn;...
